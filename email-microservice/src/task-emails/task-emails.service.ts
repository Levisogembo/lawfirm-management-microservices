...
@Injectable()
export class TaskEmailsService {
    ...
    async sendEmailNotifcation(to:string,assignedBy:string,task:string){
        try {
            const info = await this.transporter.sendMail({
                from: this.configService.get<string>("SMTP_USER"),
                to,
                subject: `New Task Assigned - ${task}`,
                text: `You have been assigned a new task. Please log in to see more details on the task`,
                attachments: [
                    {
              ...
              <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #eee; border-radius: 8px;">
                ...
                <p style="color: #555; font-size: 14px; line-height: 1.6;">
                  Hi there,<br/><br/>
                  You have been assigned a new task. Please log in to the site to see the task details.
                  <br/><br/>
                  <b> Task Name: ${task} </b><br/><br/>
